...
@section('content')
    <header class="navbar-wrapper">
        <div class="navbar navbar-fixed-top">
            <div class="container-fluid cl">
                <a class="logo navbar-logo f-l mr-10 hidden-xs" href="{{url('/admin/index')}}">H-ui.admin</a>
    ...
    <aside class="Hui-aside">
        ...
        <div class="menu_dropdown bk_2">
            <dl id="menu-product">
                <dt><i class="Hui-iconfont">&#xe681;</i> 分类管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
                </dt>
                <dd>
                    <ul>
                        <li><a data-href="{{url('admin/caipu_category')}}" data-title="菜谱分类" href="javascript:void(0)">菜谱分类</a></li>
                        <li><a data-href="{{url('admin/shicai_category')}}" data-title="食材分类" href="javascript:void(0)">食材分类</a></li>
                    </ul>
                </dd>
            </dl>
            <dl id="menu-article">
                ...
                <dd>
                    <ul>
                        <li><a data-href="{{url('admin/cookbook')}}" data-title="菜谱管理" href="javascript:void(0)">菜谱管理</a></li>
                    </ul>
                </dd>
            </dl>
            <dl id="menu-picture">
